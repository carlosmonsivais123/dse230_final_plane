...
class Create_EDA_Plots:
        ...
        def origin_destination_counts(self):
                ...
                fig.write_image("gs://dse_230_plane/EDA_Static_Images/Origin_Destination_Airport_Count.png")
        ...
        def correlation_matrix(self):
                ...
                fig.write_image("gs://dse_230_plane/EDA_Static_Images/Correlation_Plot.png")

        def pairplot(self):
                fig = sns.PairGrid(self.integer_df_drop_na.limit(2000).toPandas())
                fig.map_diag(sns.histplot)
                fig.map_offdiag(sns.scatterplot)
                plt.savefig('gs://dse_230_plane/EDA_Static_Images/Pairplot.png')
        ...
        def summary_table(self):
                ...
                fig.update_layout(width=1500,
                                  height=900)
                fig.write_image("gs://dse_230_plane/EDA_Static_Images/Summary_Table.png")
        ...
        def null_values(self):
                ...
                fig.write_image("gs://dse_230_plane/EDA_Static_Images/Null_Values.png")
