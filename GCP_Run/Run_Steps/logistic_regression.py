...
dataproc_spark.run_spark(project_id=project_id,
                         ...
                         cluster_name=cluster_name,
                         gcp_credentials=gcp_credentials,
                         main_pyspark_file='gs://plane-pyspark-run/DataProc_Files/model_dataproc_main.py',
                         other_pyspark_files=["gs://plane-pyspark-run/DataProc_Files/model_dataproc_spark_commands.py",
                                              "gs://plane-pyspark-run/DataProc_Files/dataproc_spark_session.py"])
